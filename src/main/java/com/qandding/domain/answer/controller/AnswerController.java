...
public class AnswerController {
	...
	public ResponseEntity<Long> create(@AuthenticationPrincipal CustomUserPrincipal principal,
		...
		AnswerPost post;
		if (ai != null) {
			post = answerPostRepository.save(new AnswerPost(user, question, ai, req.title(), req.content()));
		} else {
			post = answerPostRepository.save(new AnswerPost(user, question, req.title(), req.content()));
		}
